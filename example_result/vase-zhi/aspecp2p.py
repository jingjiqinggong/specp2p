...
set_gl()
from p2p.p2p import *
image_path1 =  "./tedbench/originals/vase_01.jpeg"
image_path2 = "./gradio_app/flower5.png"  # 这里最好用原图吧
image_cut = "./gradio_app/flower5.png"       # imga2 用AI抠图 去掉背景的  为了获取mask  https://photokit.com/editor/?lang=zh https://tool.lu/cutout/
...
prompts = ["a vase of carnation",
           "",
           "a vase of flowers",     #origami flowers    cupcakes
]
target_words = ["flowers"]        # 记得设置成和和local blend的相同哦
...
gl.speckv_step = (45,50)  # 优先级比 self_replace_steps 高
...
blend_word = None
blend_word = (("carnation",), ("flowers",))# for local edit. If it is not local yet - use only the source object: blend_word = ((('cat',), ("cat",))).
