...
set_gl()
from p2p.p2p import *
image_path1 =  "./images714/human6.jpg"
image_path2 = "./gradio_app/dress5.jpg"  # 这里最好用原图吧
image_cut = "./gradio_app/dress5.jpg"    # imga2 用AI抠图 去掉背景的  为了获取mask  https://photokit.com/editor/?lang=zh https://tool.lu/cutout/
...
prompts = ["A person, wearing white dress, sitting on the bench, reading a book",
           "",
        "A person, wearing colorful plaid dress, sitting on the bench, reading a book"
]
target_words = ["colorful","plaid","dress"]       # 记得设置成和和local blend的相同哦
...
gl.speckv_step = (30,50)  # 优先级比 self_replace_steps 高   4 也行
gl.speckv_layer = (14,16)   # <= <       不能要10
...
if hasattr(gl,'speckvs'):
    editor_half = AttHalfMutualMask(thres=0.32, mask_s=mask_image[0,0,:,:], 
...
self_replace_steps = 0.6 # 哈士奇的图 用0.6吧
blend_word = None
blend_word = (("white","dress"), ("colorful","plaid","dress"))# for local edit. If it is not local yet - use only the source object: blend_word = ((('cat',), ("cat",))).
