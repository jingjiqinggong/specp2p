...
image_path2 = "./gradio_app/dog13.jpg"  # 这里最好用原图吧
image_cut = "./gradio_app/dog13.png"    # imga2 用AI抠图 去掉背景的  为了获取mask  https://photokit.com/editor/?lang=zh https://tool.lu/cutout/
