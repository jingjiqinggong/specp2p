...
set_gl()
from p2p.p2p import *
image_path1 =  "./imgs/gnochi_mirror_1.jpeg"
image_path2 = "./imgs/dog13.jpg"  # 这里最好用原图吧
image_cut = "./imgs/dog13.png"    # imga2 用AI抠图 去掉背景的  为了获取mask  https://photokit.com/editor/?lang=zh https://tool.lu/cutout/
...
target_words = ["dog"]       # 记得设置成和和local blend的相同哦
...
if hasattr(gl,'speckvs'):
    editor_half = AttHalfMutualMask(thres=0.5, mask_s=mask_image[0,0,:,:], 
                            ...
                            polatemode="nearest")  # 对cross attmap的上采样插值方式   nearest,bilinear,bicubic
